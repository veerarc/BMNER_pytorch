...
def getConceptIndexForTag(concept):
    if 'B-problem' in concept:
        return [1,0,0,0,0,0,0,0]
    if 'I-problem' in concept:
        return [0,1,0,0,0,0,0,0]
    if 'B-test' in concept:
        return [0,0,1,0,0,0,0,0]
    if 'I-test' in concept:
        return [0,0,0,1,0,0,0,0]
    if 'B-treatment' in concept:
        return [0,0,0,0,1,0,0,0]
    if 'I-treatment' in concept:
        return [0,0,0,0,0,1,0,0]
    if 'B-medication' in concept:
        return [0,0,0,0,0,0,1,0]
    if 'I-medication' in concept:
